...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `UnicodeSegmentation.swiftmodule/`
...
//      `import UnicodeSegmentation` above would fail at compile time.
//
//   2. The static archive `libUnicodeSegmentation.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "UnicodeSegmentation" }` and
//      `flattenPackage = "io.github.kotlinmania.unicodesegmentation"` configuration in
...
//      via the `UnicodeSegmentationLibrary` product.
//
