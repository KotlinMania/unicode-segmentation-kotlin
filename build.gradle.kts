...
kotlin {
    ...
    swiftExport {
        moduleName = "UnicodeSegmentation"
        flattenPackage = "io.github.kotlinmania.unicodesegmentation"
    }

    android {
        namespace = "io.github.kotlinmania.unicodesegmentation"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "unicode-segmentation-kotlin", version.toString())

    pom {
        name.set("unicode-segmentation-kotlin")
        description.set("Kotlin Multiplatform port of unicode-rs/unicode-segmentation - This crate provides Grapheme Cluster, Word and Sentence boundaries according to Unicode Standard Annex #29 rules")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/unicode-segmentation-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/unicode-segmentation-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/unicode-segmentation-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/unicode-segmentation-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleUnicodeSegmentationXCFramework",
    "assembleUnicodeSegmentationDebugXCFramework",
    "assembleUnicodeSegmentationReleaseXCFramework",
    "assembleDebugIosFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleReleaseIosFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleDebugMacosFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleReleaseMacosFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleDebugTvosFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleReleaseTvosFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleDebugWatchosFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleReleaseWatchosFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForUnicodeSegmentationXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForUnicodeSegmentationXCFramework",
