...
This file is the quick-reference operating contract for unicode-segmentation-kotlin. The longer
...
unicode-segmentation-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`unicode-segmentation`](https://crates.io/crates/unicode-segmentation). Upstream Rust is the behavioral oracle while the
